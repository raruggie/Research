...
# the rest of this section is commented out because will only run when
# a pair of l.NWIS.CDL.... file is read in
...
# the rest of this setion is commented out since only runs with 
# a pair of l.NWIS.NLCD... files are read in:
